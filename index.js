...
// APIkey='AIzaSyB62M6Hvk8QxhFLK4BgJTkjS6mz_iQm4vM'
// APIkey='AIzaSyB62M6Hvk8QxhFLK4BgJTkjS6mz_iQm4vM'
...
$(document).ready(function() {
    ...
    function enableShowButtons() {
        $('.js-show-option-container').on('click', '.js-show-option', function() {
            console.log('`show-option` was clicked')
            let selectedShow = $(this).attr('data-show')
            console.log('selectedShow is', selectedShow)
    ...
    function displayLatestVid(latestVidForShow) {
        console.log('`latestVidForShow is ', latestVidForShow)
    ...
    function displayShowAndVidOptions() {
        ...
        if ( selectedProfile.style.display === "none") {
            ...
            console.log('`displayShowAndVidOptions` thinks selectedProfile.style.display === "none"')
            ...
            console.log('`displayShowAndVidOptions` thinks selectedProfile.style.display === "show"')
    ...
    fetchAllShowData()
        .then((showDataList) => {
            console.log('showDataList is', showDataList)
            console.log('allChivoloShows is', allChivoloShows)
    ...
    $('.button-section').on('click', '.grownups-button', function() {
        console.log('`Grownups` button was clicked')
        $('header').removeClass('relative')
        $('header').addClass('fixed')
    ...
    // Grownups section
        ...
        function toggleProfiles() {
            console.log('`Profiles` section was clicked')
        ...
        $('.toggle-profiles').on('click', '.new-profile-button', function() {
            console.log('`New Profile` section was clicked')
            toggleNewProfile()
        })

        $('.new-profile-form').on('click', '.submit', function() {
            console.log('New profile was submitted')
            ...
            $('.selected-profile').append(`<p class="js-selected-profile-name" data-name=${profileName}>${profileName}</p> <p class="js-selected-profile-age" data-age=${profileAge}>Age: ${profileAge}</p>`)
        })
        ...
        $('.current-profiles').on('click', '.profile', function() {
            ...
            $('.selected-profile').empty()
            $('.selected-profile').append(`<p class="js-selected-profile-name" data-name=${currentProfileName}>${currentProfileName}</p> <p class="js-selected-profile-age" data-age=${currentProfileAge}>Age: ${currentProfileAge}</p>`)
            $('.selected-profile').show()
            $('.js-video-section').empty()
            $('.js-show-option-container').empty()
            sendFirstShowToVidPlayer()
        ...
        function toggleAccount() {
            console.log('toggleAccount ran')
            let account = document.getElementById("toggle-account");
        ...
        $('.js-grownups').on('click', '.js-account-button', function() {
            console.log('`Account` section was clicked')
            toggleAccount()
        })

        $('.toggle-account').on('click', '.log-in-button', function() {
        ...
        function toggleTimer() {
            console.log('toggleTimer ran')
            let timer = document.getElementById("toggle-timer");
        ...
        $('.js-grownups').on('click', '.js-timer-button', function() {
            console.log('`Timer` section was clicked')
    ...
    // Shows section
        ...
        $('.shows-back-arrow').on('click', function() {
            console.log('`Back` arrow was clicked')
            $('header').removeClass('relative')
            $('header').addClass('fixed')
            $('.shows-back-arrow').hide()
            $('main').addClass('main-padding')
